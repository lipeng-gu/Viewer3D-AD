...
from utils.nusc_utils.mmdet3d_plugin.models.utils.detr3d_transformer import Detr3DCrossAtten
...
class Detr3DTrackingTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 decoder=None,
                 **kwargs):
        super(Detr3DTrackingTransformer, self).__init__(**kwargs)
